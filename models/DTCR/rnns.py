...
class dilated_encoder():
    ...
    def encoder(self, inputs):
        ...
        outputs_fw, states_fw = multi_dRNN_with_dilations(cell_fw_list, inputs, self.dilations, scope='forward_drnn')
        ...
        outputs_bw, states_bw = multi_dRNN_with_dilations(cell_bw_list, inputs_bw, self.dilations, scope='backward_drnn')        
